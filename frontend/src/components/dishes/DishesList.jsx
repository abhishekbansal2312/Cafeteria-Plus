...
import { updateDish } from "../../slices/dishesSlice";

import { deleteDish } from "../../slices/dishesSlice";
const DishesList = ({ dishes }) => {
  ...
  const handleEdit = async (dish) => {
    const url = `http://localhost:3000/api/dishes/${dish._id}`;
    const response = await makeRequest(url, "PUT", dish, true);
